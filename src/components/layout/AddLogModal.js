...
const AddLogModal = () => {
  ...
  return (
    <div id="add-log-modal" className="modal" style={modalStyle}> {/* The id refers to a tag href for the button on AddBtn */}
      <div className="modal-content">
        ...
        <div className="row">
          <div className="input-field">
            <p>
              <label> {/*Leaving htmlFor will break the checkbox*/}
                <input
                  type="checkbox"
                  className="filled-in"
                  checked={attention}
